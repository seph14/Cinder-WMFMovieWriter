			...
			public:
				...
				class Format {
					public:
						...
						Format&		hardwareAcceleration(const bool& enabled) { mHardwareAcceleration = enabled; return *this; }
						bool		getHardwareAccelerationEnabled() { return mHardwareAcceleration; }
